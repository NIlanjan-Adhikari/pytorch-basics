...
- [Intel Document Automation GitHub](https://github.com/intel/document-automation)
- [AWS Scalable Document Processing Patterns](https://aws.amazon.com/blogs/architecture/building-a-scalable-document-pre-processing-pipeline/)
